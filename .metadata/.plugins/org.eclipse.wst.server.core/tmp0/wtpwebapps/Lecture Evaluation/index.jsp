...
%>
	...
	<ul class="pagination justify-content-center mt-3">
		...
		<%
			if (pageNumber <= 0) {
				%>
			<a class="page-link disable">이전</a>
				<%
			} else {
				%>
		...
		<%
			if (evaluationList.size() < 6) {
				%>
			<a class="page-link disable">다음</a>
				<%
			} else {
				%>
			<a class="page-link" href="./index.jsp?lectureDivide=<%= URLEncoder.encode(lectureDivide, "UTF-8") %>
	...
	<!-- 평가 등록 모달 -->
	<div class="modal fade" id="registerModal" tabindex="-1" role="diolog" aria-labelledby="modal" aria-hidden="true">
	...
	<!-- 신고 모달 -->
	<div class="modal fade" id="reportModal" tabindex="-1" role="diolog" aria-labelledby="modal" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
